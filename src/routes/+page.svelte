...
<div class="grid gap-4">
  ...
  <div class="p-4 mx-4 mt-4 text-sm rounded-md bg-white/10">
    The Taleweave platform is in alpha and under active development. If you find any bugs or issues, please file an issue on our <a class="text-orange-300 hover:text-orange-400" target="_blank" href="https://github.com/joshwcorbett/taleweave">Github</a>.
  </div>
